...
const ELEMENTS := {
	...
	"shadow": {
		"id": "shadow",
		"display_name": "Shadow",
		"description": "Dark violet energy that weakens enemy contact damage.",
		"primary_color": Color(0.34, 0.12, 0.62),
		"secondary_color": Color(0.82, 0.5, 1.0),
		"impact_color": Color(0.68, 0.3, 1.0),
		"short_summary": "High impact that weakens enemies.",
		"strengths": "Reduces incoming contact pressure.",
		"weaknesses": "No damage-over-time effect.",
		"scaling_keywords": "weaken, contact control, shadow",
		"preview_id": "shadow",
		"available": true,
		"effect_id": "weaken",
		"effect_power": 0.78,
		...
		"tags": ["weaken", "shadow"],
		"modifiers_text": "+12% damage and weakens contact damage for 1.6s.",
	},
	"poison": {
		"id": "poison",
		"display_name": "Poison",
		"description": "Acid-green energy that applies corrosive damage over time.",
		...
		"available": true,
		"strengths": "Reliable damage after the initial hit.",
		"weaknesses": "Lower immediate impact.",
		...
		"modifiers_text": "Applies Poison for 2.0s with corrosive ticks.",
	},
	"gravity": {
		"id": "gravity",
