...
var skill_definitions := {
	...
	"unlock_summoning": {"id": "unlock_summoning", "name": "Summoning", "description": "Implemented Cast Type for autonomous player echoes.", "branch": "cast_unlocks", "cost": 78, "prerequisites": ["unlock_persistent_waves"], "implemented": true, "position": Vector2(650.0, 1040.0)},
